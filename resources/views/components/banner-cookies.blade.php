<div class="cookie-consent fixed bottom-0 left-0 w-full z-50 p-4 md:p-6 bg-gray-900 opacity-90 text-white">
    <div class="container mx-auto flex flex-wrap items-center justify-between">
      ...
      <div>
        <button id="rcc-confirm-button" class="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded transition duration-300" aria-label="Accept cookies">
            ACEPTAR
        </button>
      </div>
    </div>
