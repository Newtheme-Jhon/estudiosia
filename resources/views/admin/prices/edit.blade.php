...
<div class="flex">
    <div class="flex-1">
        <h1 class="mb-3 text-2xl font-semibold">Editar Precio</h1>
    </div>
</div>
...
<div class="flex bg-gray-100 rounded-t-lg p-4 items-center">
    ...
    <div>
        <h3 class="font-semibold text-2xl"> {{$price->value}} </h3>
    </div>
</div>
<div class="card">
    <form action="{{route('admin.prices.update', $price)}}" method="POST" class="w-full">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="col-span-1">
                <div class="w-full">
                    ...
                    <x-input type="number" name="value" id="value" value="{{$price->value}}" class="w-full mt-1" step="0.33"></x-input>
