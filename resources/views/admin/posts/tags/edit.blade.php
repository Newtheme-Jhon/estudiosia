        ...
        <div class="grid grid-cols-6">
            <div class="col-span-6 md:col-span-3">
                <div class="mb-4">
                    ...
                    <x-input name="title" id="title" placeholder="Escriba el nombre de la categoria" class="w-full" value="{{$tag->title}}"></x-input>
                    <x-input-error for="title"></x-input-error>
                </div>

                <div class="mb-4">
                    <x-label class="font-semibold mb-1">Slug</x-label>
                    <x-input name="slug" id="slug" class="w-full text-gray-600" value="{{$tag->slug}}" readonly></x-input>
