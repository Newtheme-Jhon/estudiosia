<!--button to create sections position-->
<!--en el controlador del componente utilizaremoos dispath() para disparar el evento:
close-section-position-create, esto pondra open en false y cerrara el input-->
    ...
    <div x-show="open" x-cloak class="mt-6">
        ...
        <form wire:submit="storePosition({{ $section->id }})">
            <div class="bg-gray-100 rounded-lg shadow-lg p-6">
                <x-label id="createPositionNuevaSeccion">
                    Nueva sección
                </x-label>

                <x-input id="namesection" wire:model="sectionPositionCreate.{{ $section->id }}.name"
